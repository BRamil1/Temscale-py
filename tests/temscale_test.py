...
class TestTemscale(unittest.TestCase):
    ...
    def test_constructor(self):
        ...
        self.assertEqual(tem.value(), 100)
        self.assertEqual(tem.type(), "C")
    ...
    def test_to_celsius(self):
        ...
        tem_k.to_celsius()
        tem_f.to_celsius()
        self.assertEqual(tem_k.value(), -173.14999999999998)
        self.assertEqual(tem_f.value(), 37.77777777777778)
    ...
    def test_to_kelvin(self):
        ...
        tem_c.to_kelvin()
        tem_f.to_kelvin()
        self.assertEqual(tem_c.value(), 373.15)
        self.assertEqual(tem_f.value(), 310.9277777777778)
    ...
    def test_to_fahrenheit(self):
        ...
        tem_c.to_fahrenheit()
        tem_k.to_fahrenheit()
        self.assertEqual(tem_c.value(), 212.0)
        self.assertEqual(tem_k.value(), -279.67)

    def test_to_convert(self):
        tem = temscale.Temscale(100, "C")
        tem.convert("F")
        self.assertEqual(round(tem.value(), 2), 212.0)
        tem.convert("K")
        self.assertEqual(round(tem.value(), 2), 373.15)
        tem.convert("C")
        self.assertEqual(round(tem.value(), 2), 100)
